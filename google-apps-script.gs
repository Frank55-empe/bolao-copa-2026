/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║         BOLÃO COPA 2026 — GOOGLE APPS SCRIPT v6.1              ║
 * ╚══════════════════════════════════════════════════════════════════╝
 */
...
// ─── Formata data/hora vindas do Sheets (podem ser objeto Date ou string) ────
...
function formatarHora(val) {
  ...
  // Alguns Sheets retornam hora como número decimal (fração do dia)
