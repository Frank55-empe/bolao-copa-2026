...
export default function Pix() {
  ...
  // ✅ CORRIGIDO: ao confirmar PIX →
  //   1. Abre WhatsApp do USUÁRIO automaticamente (com comprovante)
  //   2. Marca como confirmado para mostrar tela de sucesso
  const handleConfirmPix = () => {
    // Abre automaticamente o WhatsApp do usuário com o comprovante
    if (predictionState) {
      ...
      <div className="max-w-md w-full mx-auto pb-8 px-4">
        ...
        >
          ...
          <div className="space-y-3">
            {/* Envia comprovante para o ADMIN */}
            <button
  ...
  return (
    <div className="max-w-md w-full mx-auto pb-8 px-4">
      ...
      >
        ...
        {/* ✅ BOTÃO PRINCIPAL: Confirmar PIX → abre WhatsApp do usuário + vai para tela de sucesso */}
        <motion.button
          whileTap={{ scale: 0.97 }}
